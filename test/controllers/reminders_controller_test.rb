...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post reminders_url, params: { reminder: { date_of_birth: @reminder.date_of_birth, email: @reminder.email, name: @reminder.name } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { date_of_birth: @reminder.date_of_birth, email: @reminder.email, name: @reminder.name } }
